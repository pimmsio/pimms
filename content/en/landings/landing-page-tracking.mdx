...
<Slide size="xs" noPadding noOverflow>
  <Avatars />
  <Hero>
    <H1>Track your <Primary>Landing Page</Primary> <TitleIcon icon="target" /> like a Pro</H1>
...
<Slide id="solution">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Turn your landing page into a <TitleIcon variant="h2" icon="cash" /> <Primary>Cash Machine</Primary></H2>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" delay={0.2} inView>
          <H3>See <TextHighlight color="blue">exactly</TextHighlight> what's happening</H3>
      ...
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          <div className="pt-12 md:py-12">
            <H3>Optimize <TextHighlight color="orange">automatically</TextHighlight></H3>
  ...
  <Section margin="sm">
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          <H3>Segment with <TextHighlight color="red">AI</TextHighlight></H3>
...
<Slide variant="secondary" id="pricing">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Start <TitleIcon variant="h2" icon="pricing" /> <Primary>optimizing</Primary> today</H2>
