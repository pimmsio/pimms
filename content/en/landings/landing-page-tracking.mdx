  ...
  <Section>
    <InlinePricing
      ...
      planOptions={{
        ...
        solo: {
          label: "Solo plan",
          description: "For founders and small teams optimizing landing pages with UTMs and conversion tracking.",
        },
        pro: {
          label: "Pro plan",
        ...
        business: {
          label: "Business plan",
          description: "For teams and agencies scaling traffic, experiments, and analytics retention.",
        },
      }}
      includedInPlanTitle={
        <>
