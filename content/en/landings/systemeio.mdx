...
<Slide id="why-pimms">
  ...
  <Section>
    ...
    <ComparisonContainer>
      ...
      <ComparisonRow others={false} pimms={true}>Native Systeme.io funnel tracking</ComparisonRow>
...
<Slide variant="secondary" id="pricing">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Fair <Primary icon="pricing">Pricing</Primary> for your funnels</H2>
...
<Slide variant="secondary" id="free">
  <Section variant="card">
    <Centered>
      ...
      <Text>If you made it this far, it's time to connect your funnel to Pimms.</Text>
      <CtaButton href="/api/pay?id=9B66oG2VvcYq3STaGmc7u07"><SwapRotate>Start tracking funnels</SwapRotate></CtaButton>
