  ...
  <Section>
    <InlinePricing
      ...
      planOptions={{
        ...
        solo: {
          label: "Solo plan",
          description: "For solo founders, creators, freelancers, and small agencies getting started with tracking."
        },
        pro: {
          label: "Pro plan",
        ...
        business: {
          label: "Business plan",
          description: "For growing teams and marketing agencies that need higher volume, collaboration, and retention."
        }
      }}
      includedInPlanTitle={
        <>
