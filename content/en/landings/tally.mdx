---
title: Track your Tally Forms with Smart Links that grow your Revenue
summary: For marketers, creators and growth teams who want to track every form submission and know exactly which campaign drives qualified leads.
publishedAt: 2025-09-04
updatedAt: 2026-02-19
slug: tally-form-conversion-tracking
folder: solutions
...
<Slide size="xs" noPadding noOverflow>
  <Avatars />
  <Hero>
    <H1>Track your <InlineLogo src="/static/symbols/integrations/tally.svg" alt="Tally" /> <Primary icon="sales">Forms</Primary></H1>
    <Summary>For marketers, creators and growth teams who want to track every form submission and know exactly which campaign drives qualified leads.</Summary>
  </Hero>
  <AnimatedCentered noPadding>
    <CtaButton href="/api/pay?id=9B66oG2VvcYq3STaGmc7u07"><SwapRotate>Start tracking your forms</SwapRotate></CtaButton>
...
<Slide variant="secondary" id="problem">
  ...
  <Section variant="card">
    <Text size="lg">You're using Tally for lead capture and driving traffic, but you're **stuck guessing which campaigns actually drive form submissions** and missing opportunities to scale what's working.</Text>
    <List>
      <Item variant="problem">**You're spending hours on manual reporting** — piecing together data from LinkedIn, email, and Tally</Item>
      ...
      <Item variant="problem">**You can't scale what works** — without knowing which campaigns drive real form submissions, you're guessing with your outreach</Item>
      <Item variant="problem">**You're stuck in the weeds** — analyzing spreadsheets instead of capturing more qualified leads</Item>
...
<Slide id="features">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <Text size="lg">(Native Tally integration in one click 😉)</Text>
    </Centered>
  </BlurFade>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" delay={0.2} inView>
          ...
          <Text>Share smart links in your email sequences, YouTube campaigns, and LinkedIn ads that redirect to your Tally form.</Text>
          <Text>Pimms deeplinks remove the hassle of in-app browsers, making your form signups <Stronger className="text-vibrant-green">happen 30% more often</Stronger> automatically.</Text>
        </BlurFade>
      </Column>
      ...
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          <div className="pt-8 md:py-12">
            ...
            <Text>Collect high-quality leads and signals from every campaign <Stronger className="text-vibrant-blue">across all your channels</Stronger> that match with your Tally forms.</Text>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Understand which Tally prospects are most likely to convert and focus your efforts <Stronger className="text-vibrant-orange">on the highest-value opportunities</Stronger>.</Text>
        </BlurFade>
      </Column>
      <Column span={1} order="visual">
        <BlurFade direction="right" delay={0.2} inView>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Monitor lead behavior in real time. Track campaign results, A/B tests, and how your Tally form journeys are performing.</Text>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Native integrations with Tally obviously, but also Stripe, Shopify, Brevo, Calendly, Cal.com, Zapier and more.</Text>
...
<Slide id="why-pimms">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Why the <Primary icon="why">top 1%</Primary> Choose Tally + PIMMS?</H2>
    </Centered>
  </BlurFade>
  ...
  <Section>
    ...
    <ComparisonContainer>
      ...
      <ComparisonRow others={false} pimms={true}>Native Tally form response tracking</ComparisonRow>
      ...
      <ComparisonRow others={false} pimms={true}>10+ native integrations (Brevo, Cal.com, Podia, Webflow...)</ComparisonRow>
    ...
    <List layout="horizontal">
      <BlurFade direction="up" delay={0.1} inView>
        <FeatureCard variant="fancy" color="cyan">
          ...
          <Text>Share Tally form links across all channels. Create branded UTM campaigns and track every traffic source.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.2} inView>
        <FeatureCard variant="fancy" color="orange">
          ...
          <Text>Connect Tally, Brevo, Cal.com, Lemlist, and more. Automate your outreach and convert visitors into qualified leads.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.3} inView>
        <FeatureCard variant="fancy" color="green">
          ...
          <Text>Connect Tally submissions instantly. Track every lead back to its source and see which campaigns drive revenue.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.4} inView>
        <FeatureCard variant="fancy" color="cyan">
          ...
          <Text>Spot what drives revenue with real-time insights. Optimize campaigns on the fly and scale your lead capture.</Text>
        </FeatureCard>
      </BlurFade>
    </List>
  </Section>
...
<Slide variant="secondary" id="pricing">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Fair <Primary icon="pricing">Pricing</Primary> for your forms</H2>
      <Text size="lg">Start tracking your Tally performance today. Scale when you need more.</Text>
...
::: faq
### How does the Tally integration work?
PIMMS connects natively to Tally via webhook. Add hidden fields to your Tally form to pass UTM parameters automatically. Every form submission is attributed to the exact link and campaign that drove it.
:::
...
<Slide variant="secondary" id="free">
  <Section variant="card">
    <Centered>
      ...
      <Text>If you made it this far, it's time to connect your Tally forms to Pimms.</Text>
      <CtaButton href="/api/pay?id=9B66oG2VvcYq3STaGmc7u07"><SwapRotate>Start tracking your forms</SwapRotate></CtaButton>
