...
<Slide size="xs" noPadding noOverflow>
  <Avatars />
  <Hero>
    <H1>Track your <InlineLogo src="/static/symbols/integrations/calcom.svg" alt="Cal.com" /> <Primary icon="sales">Bookings</Primary></H1>
...
<Slide variant="secondary" id="problem">
  ...
  <Section variant="card">
    <Text size="lg">You're using Cal.com for meetings and driving traffic, but you're **stuck guessing which campaigns actually drive bookings** and missing opportunities to scale what's working.</Text>
    <List>
      <Item variant="problem">**You're spending hours on manual reporting** — piecing together data from LinkedIn, email, and Cal.com</Item>
      <Item variant="problem">**You're missing your best performers** — that LinkedIn post or email could be driving most of your bookings, but you'll never know</Item>
      <Item variant="problem">**You can't scale what works** — without knowing which campaigns drive real meetings, you're guessing with your outreach</Item>
      <Item variant="problem">**You're stuck in the weeds** — analyzing spreadsheets instead of booking more qualified calls</Item>
      <Item variant="problem">**Result: Your competitors who track properly are outbooking you** while you're buried in busywork</Item>
    </List>
  </Section>
</Slide>
...
<Slide id="features">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <Text size="lg">(Native Cal.com integration in one click 😉)</Text>
    </Centered>
  </BlurFade>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" delay={0.2} inView>
          ...
          <Text>Share smart links in your email sequences, YouTube campaigns, and LinkedIn ads that redirect to your Cal.com booking page.</Text>
      ...
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          <div className="pt-8 md:py-12">
            ...
            <Text>Collect high-quality leads and signals from every campaign <Stronger className="text-vibrant-blue">across all your channels</Stronger> that match with your Cal.com bookings.</Text>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Understand which Cal.com prospects are most likely to convert and focus your efforts <Stronger className="text-vibrant-orange">on the highest-value opportunities</Stronger>.</Text>
        </BlurFade>
      </Column>
      <Column span={1} order="visual">
        <BlurFade direction="right" delay={0.2} inView>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Monitor lead behavior in real time. Track campaign results, A/B tests, and how your Cal.com booking journeys are performing.</Text>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Native integrations with Cal.com obviously, but also Stripe, Shopify, Brevo, Calendly, Systeme.io, Zapier and more.</Text>
...
<Slide id="why-pimms">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Why the <Primary icon="why">top 1%</Primary> Choose Cal.com + PIMMS?</H2>
    </Centered>
  </BlurFade>
  ...
  <Section>
    ...
    <ComparisonContainer>
      ...
      <ComparisonRow others={false} pimms={true}>Native Cal.com booking & meeting attribution</ComparisonRow>
      ...
      <ComparisonRow others={false} pimms={true}>10+ native integrations (Calendly, Brevo, Tally, Webflow...)</ComparisonRow>
    ...
    <List layout="horizontal">
      <BlurFade direction="up" delay={0.1} inView>
        <FeatureCard variant="fancy" color="cyan">
          ...
          <Text>Share Cal.com booking links across all channels. Create branded UTM campaigns and track every traffic source.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.2} inView>
        <FeatureCard variant="fancy" color="orange">
          ...
          <Text>Connect Cal.com, Brevo, Tally, Lemlist, and more. Automate your outreach and convert visitors into qualified leads.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.3} inView>
        <FeatureCard variant="fancy" color="green">
          ...
          <Text>Connect Cal.com bookings instantly. Track every meeting back to its source and see which campaigns drive revenue.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.4} inView>
        <FeatureCard variant="fancy" color="cyan">
          ...
          <Text>Spot what drives revenue with real-time insights. Optimize campaigns on the fly and scale your bookings.</Text>
        </FeatureCard>
      </BlurFade>
    </List>
  </Section>
...
<Slide variant="secondary" id="pricing">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <Text size="lg">Start tracking your Cal.com performance today. Scale when you need more.</Text>
    </Centered>
  </BlurFade>
...
PIMMS connects natively to Cal.com via webhook—no Zapier needed. Add hidden fields to your Cal.com booking form to pass UTM parameters automatically. Every booking is attributed to the exact link and campaign that drove it.
:::
...
<Slide variant="secondary" id="free">
  <Section variant="card">
    <Centered>
      ...
      <Text>If you made it this far, it's time to connect your Cal.com bookings to Pimms.</Text>
      <CtaButton href="/api/pay?id=9B66oG2VvcYq3STaGmc7u07"><SwapRotate>Start tracking your bookings</SwapRotate></CtaButton>
