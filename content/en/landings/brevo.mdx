  ...
  <Section>
    <InlinePricing
      ...
      planOptions={{
        ...
        solo: {
          label: "Solo plan",
          description: "For solo marketers, creators, and small teams getting started with attribution.",
        },
        pro: {
          label: "Pro plan",
        ...
        business: {
          label: "Business plan",
          description: "For agencies, SMEs, and marketing teams scaling volume and collaboration.",
        },
      }}
      includedInPlanTitle={
        <>
