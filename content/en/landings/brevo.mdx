...
<Slide size="xs" noPadding noOverflow>
  <Avatars />
  <Hero>
    <H1>Track your <InlineLogo src="/static/symbols/integrations/brevo.svg" alt="Brevo" /> <Primary icon="sales">Campaigns</Primary></H1>
    <Summary>For marketers, agencies and growth teams who want to track every email, form and meeting — and know exactly which campaign drives revenue.</Summary>
  </Hero>
  <AnimatedCentered noPadding>
    <CtaButton href="/api/pay?id=9B66oG2VvcYq3STaGmc7u07"><SwapRotate>Start tracking your campaigns</SwapRotate></CtaButton>
...
<Slide variant="secondary" id="problem">
  ...
  <Section variant="card">
    <Text size="lg">You're running Brevo email campaigns and automations, but you're **stuck doing manual work instead of growing your business** and missing opportunities to scale what's actually working.</Text>
    <List>
      <Item variant="problem">**You're spending hours on manual reporting** — piecing together data from LinkedIn, Brevo, and your website</Item>
      <Item variant="problem">**You're missing your best performers** — that email sequence or form could be a goldmine, but you'll never know</Item>
      ...
      <Item variant="problem">**You're stuck in the weeds** — analyzing spreadsheets instead of optimizing your next campaign</Item>
...
<Slide id="features">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <Text size="lg">(Native Brevo integration via webhook 😉)</Text>
    </Centered>
  </BlurFade>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" delay={0.2} inView>
          ...
          <Text>Share smart links in your Brevo email sequences, newsletters, and social campaigns that redirect to your landing pages.</Text>
          <Text>Pimms deeplinks remove the hassle of in-app browsers, making your form submissions and <Stronger className="text-vibrant-green">purchases happen 30% more often</Stronger> automatically.</Text>
        </BlurFade>
      </Column>
      ...
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          <div className="pt-8 md:py-12">
            ...
            <Text>Collect high-quality leads and signals from every campaign <Stronger className="text-vibrant-blue">across all your channels</Stronger> that match with your Brevo forms and meetings.</Text>
            <Text>It's fully automated, whether you run a social campaign, an email sequence through Brevo, a webinar or a podcast.</Text>
          </div>
        </BlurFade>
      </Column>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Understand which Brevo prospects are most likely to convert and focus your efforts <Stronger className="text-vibrant-orange">on the highest-value opportunities</Stronger>.</Text>
        </BlurFade>
      </Column>
      <Column span={1} order="visual">
        <BlurFade direction="right" delay={0.2} inView>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Monitor lead behavior in real time. Track campaign results, A/B tests, and how your Brevo email sequences are performing.</Text>
    ...
    <TwoColumns ratio="1-1" variant="card" background="subtle">
      <Column span={1} order="text">
        <BlurFade direction="left" inView>
          ...
          <Text>Native integrations with Brevo obviously, but also Stripe, Shopify, Systeme.io, Calendly, Cal.com, Zapier and more.</Text>
...
<Slide id="why-pimms">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Why the <Primary icon="why">top 1%</Primary> Choose Brevo + PIMMS?</H2>
    </Centered>
  </BlurFade>
  ...
  <Section>
    ...
    <ComparisonContainer>
      ...
      <ComparisonRow others={false} pimms={true}>Native Brevo form & meeting tracking</ComparisonRow>
      ...
      <ComparisonRow others={false} pimms={true}>10+ native integrations (Cal.com, Tally, Podia, Webflow...)</ComparisonRow>
    ...
    <List layout="horizontal">
      <BlurFade direction="up" delay={0.1} inView>
        <FeatureCard variant="fancy" color="cyan">
          ...
          <Text>Share Brevo campaign links across all channels. Create branded UTM campaigns and track every traffic source.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.2} inView>
        <FeatureCard variant="fancy" color="orange">
          ...
          <Text>Connect Brevo forms, meetings, Tally, Cal.com, and more. Automate your outreach and convert visitors into qualified leads.</Text>
        </FeatureCard>
      </BlurFade>
      <BlurFade direction="up" delay={0.3} inView>
        <FeatureCard variant="fancy" color="green">
          ...
          <Text>Connect Stripe payments instantly. Track every purchase back to its Brevo campaign source and see which emails drive revenue.</Text>
        </FeatureCard>
      </BlurFade>
...
<Slide variant="secondary" id="pricing">
  <BlurFade direction="up" inView>
    <Centered>
      ...
      <H2>Fair <Primary icon="pricing">Pricing</Primary> for your campaigns</H2>
      <Text size="lg">Start tracking your campaign performance today. Scale when you need more.</Text>
...
Connect Brevo via webhook to automatically track form submissions and meeting bookings. Every conversion is attributed to the original link and UTM parameters.
:::
...
<Slide variant="secondary" id="free">
  <Section variant="card">
    <Centered>
      ...
      <Text>If you made it this far, it's time to connect your campaigns to Pimms.</Text>
      <CtaButton href="/api/pay?id=9B66oG2VvcYq3STaGmc7u07"><SwapRotate>Start tracking campaigns</SwapRotate></CtaButton>
