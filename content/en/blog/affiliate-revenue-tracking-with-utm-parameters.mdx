...
::: @iframe https://www.youtube.com/embed/CK-tzvdAkuM
:::
...
To keep everyone on the same page, create a master spreadsheet outlining your UTM guidelines. Make this document accessible to your entire team, so everyone - from social media managers to email marketers - follows the same standards [\[3\]](https://www.adroll.com/blog/utm-best-practices-the-ultimate-list). The key is to strike a balance: keep your naming conventions detailed enough to be informative but simple enough to manage.
...
- **Shorten your URLs**: Long, tagged links can look messy, especially on social media. Use tools like Google’s URL shortener or [Rebrandly](https://www.rebrandly.com/) to create cleaner, more professional links while retaining tracking data [\[1\]](https://www.crakrevenue.com/blog/utm-tracking).
