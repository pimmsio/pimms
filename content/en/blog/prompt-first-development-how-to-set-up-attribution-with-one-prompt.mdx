...
| 2.   | **Configure Links**: Include tracking parameters.   | `?pimms_id=1`                        |
| 3.   | **Create Smart Links**: Generate URLs for tracking. | Direct users to funnel entry points. |
| 4.   | **Enable Conversion**: Turn on tracking.            | Activate in the dashboard.           |
