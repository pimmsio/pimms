...
| ---------------- | ------------------- | ---------------------------- | -------------------------- | ----------------------- |
| **PIMMS**        | 5 smart links       | Mobile-first deep linking    | New to market              | Mobile-heavy campaigns  |
...
For users who need some analytics and branding features, **PIMMS** provides 5 smart links free with real-time analytics, custom domain support, and mobile app optimization - offering more advanced features than Rebrandly's 25 basic links.

**Comparison of free plans:**
- **TinyURL**: Unlimited basic links, no analytics, permanent links
- **PIMMS**: 5 smart links, real-time analytics, 1 custom domain, mobile optimization
