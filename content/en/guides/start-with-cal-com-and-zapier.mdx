...
image: https://assets.pimms.io/pimms-calcom-integration-zapier.webp?v=3
author: alexandre
categories:
  - guides
related:
...
Add this script in your site’s or page head (required for both cases):
...
- Add this additional script to the page:
