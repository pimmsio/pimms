...
2. Send the conversion event to Pimms (via API, Zapier, or npm)
...
If your Pimms script (or SDK) is installed, your links are already ready to attribute conversions — there’s no extra toggle to enable.
