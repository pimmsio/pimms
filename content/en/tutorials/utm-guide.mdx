...
### Example 1: UTM-coded link for a YouTube campaign (LinkedIn)
...
- **utm_medium:** `paid_social` – indicates paid YouTube.
...
- **Seamless user experience:**  
  Mobile users are directed to the native app (like LinkedIn, or your own app) for a frictionless experience.
...
- Optimize for superior conversion, whether through email, LinkedIn, or messaging apps
