    ...
    <Section id="lifetime" className="items-center gap-6 bg-zinc-100">
      ...
      <div className="relative rounded-3xl bg-white text-[#08272E] w-full py-6 px-4 lg:p-0 flex flex-col lg:flex-row gap-8 items-start lg:my-12">
        ...
        <div className="w-full lg:w-2/3 flex flex-col lg:flex-row gap-y-10 items-center">
          <div className="relative rounded-3xl lg:min-h-[300px] bg-zinc-100 text-[#08272E] w-full py-10 lg:px-2 lg:p-0 border-[6px] border-zinc-200 flex items-center justify-center lg:scale-110">
            <div className="flex flex-col items-center justify-between gap-6 w-full">
              <div className="flex flex-col items-center justify-between gap-6 w-full">
                <div className="text-lg font-bold">
                  {t("lifetime_offer.one_year_pass")}
                </div>
                <div className="text-4xl flex items-start leading-none font-bold">
                  <div className="inline-flex opacity-60 mr-2 text-2xl diag-strikethrough">
                    55<div className="text-sm mt-0.5">€</div>
                  </div>
                  <div className="mr-0.5 text-6xl">25</div>
                ...
                <CtaButtonBig
                  type="lifetime"
                  variant="secondary"
                  value={t("lifetime_offer.free_trial")}
                  className="w-10/12 md:w-6/12 lg:w-8/12 mx-auto"
                />
                <div className="text-xs text-transparent hidden lg:block">
          ...
          <div className="relative rounded-3xl lg:min-h-[300px] bg-zinc-100 text-[#08272E] w-full py-10 lg:px-10 lg:p-16 border-[6px] border-[#3970ff] flex items-center justify-center lg:scale-110">
            <div className="flex flex-col items-center justify-between gap-6 w-full">
