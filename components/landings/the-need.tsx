      ...
      <div className="max-w-4xl mx-auto">
        ...
        <noscript>
          <div className="bg-white border border-gray-200 p-8 space-y-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{content.withoutPimms}</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{content.withPimms}</h3>
              <Paragraph className="text-lg text-gray-600 leading-relaxed mb-6">
