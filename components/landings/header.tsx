  ...
  return (
    <header className="w-full sticky top-3 xl:top-0 z-50 bg-transparent xl:bg-white/80 xl:backdrop-blur-md xl:border-b xl:border-gray-100/50">
      <div className="max-w-5xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="h-16 xl:h-20 mt-3 xl:mt-0 bg-white/90 xl:bg-transparent backdrop-blur-md xl:backdrop-blur-0 border border-gray-100/60 xl:border-0 shadow-[0_10px_40px_-15px_rgba(42,74,155,0.2)] xl:shadow-none rounded-3xl xl:rounded-none flex items-center justify-between px-6 sm:px-8">
          ...
          <nav className="flex items-center gap-3 md:gap-4 flex-1">
            ...
            <div className="ml-auto flex items-center">
              <CtaDemo variant="secondary" className="px-4 h-9 rounded-2xl shadow-sm hover:shadow-md">
                {tcommon("cta.demo")}
              </CtaDemo>
            </div>
          </nav>
