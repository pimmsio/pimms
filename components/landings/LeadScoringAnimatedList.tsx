  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 sm:gap-4">
        <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-gray-50 ring-1 ring-gray-200">
          <Image
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <span className="truncate max-w-[180px] sm:max-w-[260px]">{maskEmail(item.email)}</span>
            <span className="hidden sm:inline">•</span>
            <span>{item.time}</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <div className="flex items-center rounded-full px-3 py-1 ring-1 " style={{}}>
            <span className="text-base sm:text-lg font-semibold text-gray-900">{item.score} %</span>
          </div>
          <div className={cn("hidden sm:flex items-center gap-1 rounded-full px-3 py-1 ring-1", meta.bg)}>
...
export default function LeadScoringAnimatedList({
  ...
  return (
    <div className={cn("relative flex h-[360px] w-full flex-col overflow-hidden", className)}>
