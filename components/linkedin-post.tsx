...
export const LinkedinPost = ({
  ...
  return (
    <div className={cn("relative flex bg-card flex-col rounded-2xl", className)}>
      <div className="flex flex-row w-full">
        <div className="flex flex-row pr-[12px] pt-[16px] pl-[12px] mb-[8px]">
          <div className="flex relative">
            <span className="flex relative justify-center items-center box-border overflow-hidden align-middle z-10 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-tiny bg-muted rounded-full w-[48px] h-[48px] min-w-[48px] min-h-[48px]">
              <img
                src={avatar}
            ...
            <div className="ml-2 flex flex-col">
              <span className="font-semibold text-[14px] text-foreground">{name}</span>
              <span className="text-muted-foreground line-clamp-1 pr-[calc(4rem+32px)] leading-[14px] text-[12px]">
                {profile}
              </span>
              <span className="text-muted-foreground line-clamp-1 pr-[calc(4rem+32px)] leading-[14px]  text-[12px]">
                {time} •
      ...
      <div className="flex flex-row px-[16px] py-[8px] justify-between">
        <div className="flex flex-row items-center">
          ...
          {showSolution && (
            <>
              <div className="flex flex-row -ml-1.5 rounded-full bg-background">
                <img
          ...
          <div className="text-[12px] leading-[14px] font-normal pl-[4px] text-muted-foreground">
            {likes}
          </div>
        </div>
        <div className="flex flex-row">
