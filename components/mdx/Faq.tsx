  ...
  return (
    ...
    >
      <details className="group" open={false}>
        <summary className="cursor-pointer py-3 px-4 sm:p-5 min-h-[44px] list-none [&::-webkit-details-marker]:hidden rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 hover:bg-gray-50/50 transition-colors flex items-center justify-between gap-4">
          <div id={questionId} className="text-sm sm:text-base font-medium text-text-primary leading-relaxed flex-1">
            {question}
          </div>
