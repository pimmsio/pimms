  ...
  return (
    <div className="mb-4 border border-gray-200 rounded-xl bg-white transition-colors hover:border-brand-primary/50">
      <details className="group" open={false}>
        <summary className="cursor-pointer p-6 list-none [&::-webkit-details-marker]:hidden rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 hover:bg-gray-50 transition-colors flex items-center justify-between gap-4">
